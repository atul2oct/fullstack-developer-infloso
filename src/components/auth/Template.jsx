    ...
    <>
        {
            ...
            (<div className='flex md:flex-row md:gap-y-0 md:gap-x-12 flex-col-reverse gap-y-12 py-12 justify-between w-11/12 max-w-maxContent mx-auto items-center min-h-[calc(100vh-3.5rem)]'>
                {/* left */}
